...
/**
  ...
  */
	 ...
	 * @param          string $name new name in server query
	 * @return void success
	 */
	function selectServer($value, $type = 'port', $virtual = false, $name = null) {
		if($name == null){ $name = ''; }else{ $name = " client_nickname=".$this->escapeText($name); }
...
/**
  ...
  *  [virtualserver_welcomemessage] => Home to TeamSpeak, check [URL]www.teamspeak.com[/URL] for latest information
